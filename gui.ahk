...
Gui, Add, Text, x65 y28 w430 h100 ,by BlackChaplin, PetrosPastor(AimAssist+ExtraTools), MgSweet(Everything else)
...
Gui, Font, S8 Bold, 
Gui, Add, Text, x142 y98 w80 h30 , voice vol:
...
Gui, Font, S8,
Gui, Add, Text, x25 y290 w100 h30 , Blind Mode:
Gui, Font, S10, 
...
if (auto_fire == "1") {
    Gui, Add, CheckBox, x330 y129 w110 h30 vauto_fire Checked, Auto Fire
} else {
    Gui, Add, CheckBox, x330 y129 w110 h30 vauto_fire, Auto Fire
}
if (enable_voice == "1") {
    Gui, Add, CheckBox, x20 y89 w120 h30 venable_voice Checked, Enable Voice
} else {
    Gui, Add, CheckBox, x20 y89 w120 h30 venable_voice, Enable Voice
}
if (auto_trigger == "1") {
    Gui, Add, CheckBox, x330 y209 w150 h30 vauto_trigger Checked, Auto Trigger
} else {
    Gui, Add, CheckBox, x330 y209 w150 h30 vauto_trigger, Auto Trigger
}
if (ads_only == "1") {
    Gui, Add, CheckBox, x330 y169 w110 h30 vads_only Checked, Ads Only
} else {
    Gui, Add, CheckBox, x330 y169 w110 h30 vads_only, Ads Only
}
Gui, Font, S9 Bold, 
if (bloodhZ_aimassist == "1") {
    Gui, Add, CheckBox, x20 y169 w120 h30 vbloodhZ_aimassist Checked, BloodhZ Aimassist
} else {
    Gui, Add, CheckBox, x20 y169 w120 h30 vbloodhZ_aimassist, BloodhZ Aimassist
}
Gui, Font, S7 Bold, 
if (gold_scope_aimassist == "1") {
    Gui, Add, CheckBox, x20 y129 w140 h30 vgold_scope_aimassist Checked, Gold Scope Aimassist
} else {
    Gui, Add, CheckBox, x20 y129 w140 h30 vgold_scope_aimassist, Gold Scope Aimassist
}
Gui, Font, S9 Bold, 
if (color_aimassist == "1") {
    Gui, Add, CheckBox, x20 y209 w120 h30 vcolor_aimassist Checked, Color Aimassist
} else {
    Gui, Add, CheckBox, x20 y209 w120 h30 vcolor_aimassist, Color Aimassist
}
if (noADS_aimassist == "1") {
    Gui, Add, CheckBox, x20 y249 w160 h30 vnoADS_aimassist Checked, noADS Aimassist
} else {
    Gui, Add, CheckBox, x20 y249 w160 h30 vnoADS_aimassist, noADS Aimassist
}
...
;create form
Gui, Show, x%xPos% y%yPos% h420 w500, % i
Return
